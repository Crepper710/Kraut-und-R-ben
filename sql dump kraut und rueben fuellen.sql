...
INSERT INTO LIEFERANT (LIEFERANTENNR, LIEFERANTENNAME, STRASSE, HAUSNR, PLZ, ORT, TELEFON, EMAIL) values (104, 'Giovani Nudelmanufaktur', 'Italienische Strasse', '1','12345', 'Italien', '012345-6789', 'bestellung@giovani-nm.it');
...
INSERT INTO ZUTAT (ZUTATENNR, BEZEICHNUNG, EINHEIT, NETTOPREIS, BESTAND, lieferant, KALORIEN, KOHLENHYDRATE, PROTEIN) VALUES (9999, 'Nudeln', 'Packung', 1.0, 10000, 104, 350, 70, 10);
...
INSERT INTO REZEPT(REZEPTNR, REZEPTNAME) VALUES (1, 'Soja Alergie Roulette');

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (1, 5001, 5);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (1, 9001, 1);


INSERT INTO REZEPT(REZEPTNR, REZEPTNAME) VALUES (2, 'Gemüse Suppe');

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (2, 1005, 2);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (2, 1006, 4);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (2, 1012, 1);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (2, 7043, 3);


INSERT INTO REZEPT(REZEPTNR, REZEPTNAME) VALUES (3, 'Nudeln mit Tomatensosse');

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (3, 9999, 1);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (3, 1003, 5);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (3, 1002, 1);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (3, 1009, 2);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (3, 1010, 1);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (3, 3002, 1);


INSERT INTO REZEPT(REZEPTNR, REZEPTNAME) VALUES (4, 'Rührei');

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (4, 4001, 3);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (4, 1012, 1);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (4, 1003, 1);


INSERT INTO REZEPT(REZEPTNR, REZEPTNAME) VALUES (5, 'Salat');

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (5, 1007, 3);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (5, 3002, 1);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (5, 1003, 3);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALUES (5, 1004, 2);


INSERT INTO ERNAEHRUNGSKATEGORIEN(ERNAEHRUNGSKATEGORIE_ID, ERNAEHRUNGSKATEGORIENAME) VALUES (1, 'Vegan');

INSERT INTO ERNAEHRUNGSKATEGORIEN(ERNAEHRUNGSKATEGORIE_ID, ERNAEHRUNGSKATEGORIENAME) VALUES (2, 'Vegetarisch');

INSERT INTO ERNAEHRUNGSKATEGORIEN(ERNAEHRUNGSKATEGORIE_ID, ERNAEHRUNGSKATEGORIENAME) VALUES (3, 'Frutarisch');

INSERT INTO ERNAEHRUNGSKATEGORIEN(ERNAEHRUNGSKATEGORIE_ID, ERNAEHRUNGSKATEGORIENAME) VALUES (4, 'Low Carb');

INSERT INTO ERNAEHRUNGSKATEGORIEN(ERNAEHRUNGSKATEGORIE_ID, ERNAEHRUNGSKATEGORIENAME) VALUES (5, 'High Protein');


INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (1, 5);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (2, 1);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (2, 4);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (3, 2);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (4, 2);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (4, 4);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (4, 5);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (5, 2);

INSERT INTO ERNAEHRUNGKATREZEPT(REZEPTNR, ERNAEHRUNGSKATEGORIE_ID) VALUES (5, 4);


INSERT INTO	BESCHRAENKUNGEN(BESCHRAENKUNGS_ID, BESCHRAENKUNGSNAME) VALUES (1, 'Laktose');

INSERT INTO	BESCHRAENKUNGEN(BESCHRAENKUNGS_ID, BESCHRAENKUNGSNAME) VALUES (2, 'Gluten');

INSERT INTO	BESCHRAENKUNGEN(BESCHRAENKUNGS_ID, BESCHRAENKUNGSNAME) VALUES (3, 'Erdnuss');

INSERT INTO	BESCHRAENKUNGEN(BESCHRAENKUNGS_ID, BESCHRAENKUNGSNAME) VALUES (4, 'Ei');

INSERT INTO	BESCHRAENKUNGEN(BESCHRAENKUNGS_ID, BESCHRAENKUNGSNAME) VALUES (5, 'Tomate');

INSERT INTO	BESCHRAENKUNGEN(BESCHRAENKUNGS_ID, BESCHRAENKUNGSNAME) VALUES (6, 'Soja');


INSERT INTO BESCHRAENKUNGENREZEPT(REZEPTNR, BESCHRAENKUNGS_ID) VALUES (1, 6);

INSERT INTO BESCHRAENKUNGENREZEPT(REZEPTNR, BESCHRAENKUNGS_ID) VALUES (3, 1);

INSERT INTO BESCHRAENKUNGENREZEPT(REZEPTNR, BESCHRAENKUNGS_ID) VALUES (3, 5);

INSERT INTO BESCHRAENKUNGENREZEPT(REZEPTNR, BESCHRAENKUNGS_ID) VALUES (4, 4);

INSERT INTO BESCHRAENKUNGENREZEPT(REZEPTNR, BESCHRAENKUNGS_ID) VALUES (4, 5);

INSERT INTO BESCHRAENKUNGENREZEPT(REZEPTNR, BESCHRAENKUNGS_ID) VALUES (5, 1);

INSERT INTO BESCHRAENKUNGENREZEPT(REZEPTNR, BESCHRAENKUNGS_ID) VALUES (5, 5);
